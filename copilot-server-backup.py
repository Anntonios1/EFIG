...
class GithubCopilotClient:
    ...
    def list_models(self) -> list:
        ...
        return [
            {"id": "gpt-4o-2024-11-20", "object": "model", "owned_by": "github-copilot"},
            {"id": "gpt-4", "object": "model", "owned_by": "github-copilot"},
            {"id": "gpt-5-mini", "object": "model", "owned_by": "github-copilot"},
            {"id": "gpt-4.1-2025-04-14", "object": "model", "owned_by": "github-copilot"},
            ...
            {"id": "o1-preview", "object": "model", "owned_by": "github-copilot"},
            {"id": "o1-mini", "object": "model", "owned_by": "github-copilot"}
        ]
...
def chat_completions():
    ...
    try:
        ...
        # Agregar tools si están presentes (function calling)
        if "tools" in data and data["tools"]:
            kwargs["tools"] = data["tools"]
            logger.info(f"Tools detectados: {len(data['tools'])} funciones")
